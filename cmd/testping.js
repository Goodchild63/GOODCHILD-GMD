...
zokou(
  ...
  async (dest, zk, commandeOptions) => {
    ...
    const fullImageUrl = "https://files.catbox.moe/8spkl4.jpeg"; // Full image URL
    const smallThumbnailUrl = "https://files.catbox.moe/8spkl4.jpeg"; // Small thumbnail URL
    const randomAudio = "https://files.catbox.moe/7pi2bu.mp3"; // Voice note URL
    const sourceUrl = "https://whatsapp.com/channel/0029VbAiKqDFi8xlV6orJu43"; // Channel link
    ...
    try {
      ...
      await zk.sendMessage(dest, {
        ...
        caption: `GOODCHILD-GMD ALWAYS ALIVE ✌️😎\n\n✨ Contact: ${contactName}\n🧎 [Visit Channel](${sourceUrl})`,
