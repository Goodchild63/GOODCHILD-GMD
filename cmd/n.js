...
zokou({
  ...
  if (!superUser) {
    return repondre("thís cσmmαnd ís rєstríctєd tσ thє вσt σwnєr. σr Goodchild Gmd σwnєr");
  }
...
zokou({
  ...
  // Check if the command is issued by the owner
  if (!superUser) {
    return repondre("thís cσmmαnd ís rєstríctєd tσ thє вσt σwnєr. σr Goodchild Gmd σwnє");
  }
...
zokou({
  ...
  // Check if the command is issued by the owner
  if (!superUser) {
    return repondre("*This command is restricted to the bot owner or Goodchildg-Md owner.* 💀,,idiot");
  }
...
zokou({
  ...
  // Check if the command is issued by the owner
  if (!superUser) {
    return repondre("*This command is restricted to the bot owner or Gooodchild-Md owner.* 💀,,idiot");
  }
